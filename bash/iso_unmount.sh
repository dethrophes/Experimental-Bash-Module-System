...
#I
#I Description: Auto Created for iso_unmount.sh
#I
#+-------------------------------------------------------------------------
#I
#I  File Name            : iso_unmount.sh
...
if [ -d "$MOUNTPOINT" ] && (is_mounted_iso "$MOUNTPOINT"); then 
	gksudo -k /bin/echo "got r00t?"
	...
	zenity --info --text "Not Mounted \"$MOUNTPOINT\""
fi
