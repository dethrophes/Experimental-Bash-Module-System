...
#+=========================================================================
#I  $HeadURL: svn+ssh://dethdeg.dvrdns.org/svn/KScripts2/trunk/bash/fsck.sh $
#+=========================================================================
...
#I  ID                   : $Id: fsck.sh 53 2012-02-17 13:29:00Z dethrophes $
#I
#+=========================================================================
#</KHeader>
if [ -z "${__fsck_sh__:-}" ]; then
	...
	fsckRevision=$(CleanRevision '$Revision: 53 $')
